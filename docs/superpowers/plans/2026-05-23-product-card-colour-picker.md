...
- [x] **Step 1: Add `placeholderBg` to `emptyForm()`**
...
- [x] **Step 2: Seed the default from the selected category when it changes**
...
- [x] **Step 3: Add the picker UI to the Basics section**
...
- [x] **Step 5: Wire form value into the publish payload**
...
- [x] **Step 1: Add `placeholder_bg` to `productForm` ref**
...
- [x] **Step 2: Populate `placeholder_bg` when loading the product**
...
- [x] **Step 3: Add the picker UI to the edit modal**
...
- [x] **Step 5: Include `placeholder_bg` in the save payload**
...
- [x] **Step 1: Start the admin dev server**

```bash
cd aroma-admin && npm run dev
```

- [x] **Step 2: Verify the Add Product drawer**
...
- [x] **Step 3: Verify the Edit Product modal**
...
- [x] **Step 4: Verify RTL/Arabic locale**
